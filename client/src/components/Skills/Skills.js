...
<div className="firebase">
                  <a className="card-title" href="https://aagladstone.github.io/Train-Post-Activity/"><h3 className="port-title fire"> <b>Firebase: Train Tracker</b> </h3> </a>
...
<div className="jQuery">
                <a className="card-title" href="https://aagladstone.github.io/Giphy-App/"><h3 className="port-title gify"><b>jQuery: Giphy Tool</b></h3></a>
                <p className="card-textGif">This cool tool populates 10 gifs of the topic the user wants to see. Here is the GitHub repository. Click <a class="repo-link" href="https://github.com/Aagladstone/Giphy-App">here</a> to go to the GitHub repository and see the code!</p>
              <img className="card-img-dak" src={dakgif} alt="Card image cap" /> <img className="card-img-todd" src={toddgif} alt="Card image cap" />
...
export function NodeLiri(props) {
  return(
<div className="node">
            <a className="card-title" href="https://github.com/Aagladstone/LIRI-BOT"><h3 className="port-title liriii"> <b>Nodejs: Liri </b> </h3> </a>
...
<div className="nodebam">
  <a className="card-title" href="https://github.com/Aagladstone/Node-MySQL"><h3 className="port-title bambam"> <b>Nodejs: Bamazon </b> </h3> </a>
...
export function Handlebars(props) {
    ...
    <div className="handlebars">
                    ...
                    <p className="card-textBurger"> This program will uses handlebars to dynamically add hamburgers of the users choosing and decide if the want to devour them or not.  </p>
