...
<div className="tracker-card container" />
        <div class="card-body" />
        <a class="card-title" href="https://mjgardner.github.io/project1/"><h3 class="port-title"> <b>Project 1: Who's Calling Me?</b> </h3> </a>
        <Fragment>
        <img class="card-img-callMe" src={callMe} alt="Card image cap" /> <img class="card-img-callingMe" src={callingMe} alt="Card image cap" /> </Fragment>
    <p class="card-text">Find out how dangerous an unknown number could be. Just use our app, and insert the number into our form, and we'll keep track of the numbers for you. <a class="repo-link" href="https://github.com/mjgardner/project1">here</a> to go to the GitHub repository and see the code! </p> 
</div>
)}
  ...
  return(
    <div className="projectTwo">
        <div className="card-body" />
            <a className="card-title" href="https://datebook-app.herokuapp.com/"><h3 class="port-title"> <b>Project 2: Datebook</b> </h3> </a>
